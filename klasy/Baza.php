...
class Baza { 
    ...
    { 
        $this->mysqli = new mysqli($serwer, $user, $pass, $baza);         /* sprawdz połączenie */         
    ...
    //Wynik funkcji – kod HTML tabeli z rekordami (String)         
        ...
        {             
            ...
            $ile = $result->num_rows; //ile wierszy             // pętla po wyniku zapytania $results             
            $tresc.="<table><tbody>";             
